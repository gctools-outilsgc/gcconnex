...
'pages:notification' => '%s added a new page: %s %s View and comment on the new page: %s ',
'pages:notify:summary' => 'Nouvelle page nommée %s',
'pages:notify:subject' => "Une nouvelle page: %s",
'pages:notify:body' => '%s a ajouté une nouvelle page: %s %s Voir et commenter cette page: %s ',		
