...
function saveProfile(event) {
    ...
    switch ($section) {
        ...
        case 'opt-in':
            ...
            opt_in_set[23] = $options.find('#gcconnex-opt-in-interchangeseek-check').is(':checked');
            opt_in_set[24] = $options.find('#gcconnex-opt-in-interchangecreate-check').is(':checked');
