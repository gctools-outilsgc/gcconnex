...
if($userEnt->profilestrength != 100){
    ...
    echo '<li><strong>'. elgg_echo("ps:basicprofile").'</strong> <span style="display: block; width:100%;"><progress class="progress-bar-striped" max="100" value="'.$basicCount .'"><span class="wb-inv">' . $basicCount . '%</span></progress><span>' . $basicCount . '%</span></span></li>';
    echo '<li><strong>'. elgg_echo('profile:skills') .'</strong> <span style="display: block; width:100%;"><progress class="progress-bar-striped" max="100" value="'.$skillCount .'"><span class="wb-inv">' . $skillCount . '%</span></progress><span>' . $skillCount . '%</span></span></li>';
    echo '<li><strong>'. elgg_echo('ps:education') .'</strong> <span style="display: block; width:100%;"><progress class="progress-bar-striped" max="100" value="'.$eduCount .'"><span class="wb-inv">' . $eduCount . '%</span></progress><span>' . $eduCount . '%</span></span></li>';
    echo '<li><strong>'. elgg_echo('ps:work') .'</strong> <span style="display: block; width:100%;"><progress class="progress-bar-striped" max="100" value="'.$workCount .'"><span class="wb-inv">' . $workCount . '%</span></progress><span>' . $workCount . '%</span></span></li>';
    echo '</ul>';
