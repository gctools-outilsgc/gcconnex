...
<div class="row clearfix">
	...
	<div style="text-align:right;">
		...
		<span name="mission-job-type"><?php echo elgg_echo($mission->job_type); if (!empty($mission->role_type)) { echo ' (' . strtolower(elgg_echo($mission->role_type)) . ')'; } ?></span> <span class="fa fa-circle mrgn-lft-sm timeStamp mrgn-bttm-sm" aria-hidden="true" style="font-size:8px"></span>
