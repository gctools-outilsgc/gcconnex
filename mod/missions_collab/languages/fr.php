...
return array(
    ...
    "missions:check_micro_missions" =>	"Consultez les micro-missions ainsi que les autres possibilités interministérielles supportés par la Carrefour de carrière de ConneXions carrière au sein du Carrefour de carrière! Inscrivez-vous à partir de votre profil GCcollab pour participer!",
    "missions:error:email_not_on_gcconnex" =>	"L'adresse de courriel '%s' n'est pas liée à un utilisateur de GCcollab.",
    "missions:saved_beginning_skill_match" =>	"Votre possibilité a été enregistrée. Nous générons en ce moment une liste d'utilisateurs de GCcollab ayant les compétences suivantes que vous avez entrées : %s.
    ...
    "missions:placeholder_b" =>"La Carrefour de carrière de ConneXions Carrière est une réalité grâce à la collaboration de nombreux employés passionnés et ministères coopératifs.",
    ...
    "missions:placeholder_k" =>	"La fonction « S'inscrire » prend en charge la fonctionnalité de ConneXions Carrière à l'intérieur du Carrefour de carrière, en parallèle avec les renseignements de votre profil GCcollab, afin de permettre aux employés de découvrir des possibilités d'intérêt.
