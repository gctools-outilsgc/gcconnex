...
return array(
    ...
    "missions:check_micro_missions" =>  "You should check out Micro-Missions and the other interdepartmental at-level mobility and development opportunities in the Career ConneXions Career Marketplace! Opt in now from your GCcollab profile to participate!",
    ...
    "missions:placeholder_b" => "The Career ConneXions Career Marketplace is a reality thanks to the collaboration of many passionate employees and supportive departments.",
    ...
    "missions:placeholder_k" => "The 'opt-in' feature supports the functionality of the Career ConneXions Career Marketplace in tandem with the information in your GCcollab profile to facilitate connecting employees with opportunities of interest.
    ...
    "missions:placeholder_a" =>   "Welcome to the Career ConneXions Career Marketplace! This is a tool that quickly matches at-level mobility (i.e. micro-missions and job swapping) and development (i.e. mentoring and job shadowing) opportunities with talented employees by leveraging the content in employees&rsquo; GCcollab profiles.
