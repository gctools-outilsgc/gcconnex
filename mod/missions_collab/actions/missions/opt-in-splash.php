...
$user = elgg_get_logged_in_user_entity();
            ...
            $opt_in_casual_seek = get_input('casualseek_check');
            $opt_in_casual_create = get_input('casualcreate_check');
            $opt_in_student_seek = get_input('studentseek_check');
...
foreach($opt_in_inputs as $k => $v){
    if($v == 'on'){
        ...
        $opt_in_inputs[$k]  = 'gcconnex_profile:opt:no';   
            ...
            $user->opt_in_shadowed = $opt_in_inputs[3];
            $user->opt_in_mentoring = $opt_in_inputs[4];
            ...
            /* MW - Added for GCcollab only */
            $user->opt_in_casual_seek = $opt_in_inputs[17];
            $user->opt_in_casual_create = $opt_in_inputs[18];
            $user->opt_in_student_seek = $opt_in_inputs[19];
