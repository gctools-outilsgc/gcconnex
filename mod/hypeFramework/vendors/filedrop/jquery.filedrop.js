...
;(function($) {
  ...
  $.fn.filedrop = function(options) {
    ...
    this.live('drop', drop).live('dragstart', opts.dragStart).live('dragenter', dragEnter).live('dragover', dragOver).live('dragleave', dragLeave);
    $(document).live('drop', docDrop).live('dragenter', docEnter).live('dragover', docOver).live('dragleave', docLeave);
