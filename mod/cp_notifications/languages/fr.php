...
$french = array( 
	...
	'cp_notification:group_invite_email' => "<p>%s</p><p><b>Joignez-vous à %s!</b></p> <p><a href='%s&language=fr&foo=/view'>Créez votre compte %s en utilisant ce lien</a> pour être automatiquement ajouté au groupe.</p>
	 <p>Si vous désirez créer votre compte à une date ultérieure en utilisant le <a href='%s&language=fr&foo=/view'>formulaire d’inscription</a> sur %s, vous pouvez vous joindre au groupe en utilisant le code suivant sur votre page d'Invitation de groupe : %s.</p> 
