<?php
	...
	$english = array(
		...
		"cp_notification:email_header_msg_en" => "This is a system-generated message from GCconnex, you're receiving this notification because there has been an update or reply to the content that you have been subscribed to. If you have any questions or concerns please consult the contact us page here: %s <br/>
												...
												Thank you",
		"cp_notification:email_header_msg_fr" => "Ceci est un message généré par le système de GCconnex , vous recevez cette notification, parce qu'il ya eu une mise à jour ou de répondre au contenu que vous avez été abonné. S'il vous plaît ne pas répondre à ce message, si vous avez des questions s'il vous plaît consulter le contactez-nous / page d'aide -link- <br/>
		...
		"cp_notify:body_friend_req:title" => "%s has sent you a friend request",
		"cp_notify:body_friend_req:description" => "%s has sent you a friend request and are waiting for you to accept them <br/>
													To view the friend request invitation please click on this linke: %s",
