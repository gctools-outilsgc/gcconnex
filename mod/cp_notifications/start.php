...
function cp_overwrite_notification_hook($hook, $type, $value, $params) {
	...
	switch ($cp_msg_type) {
		...
		case 'cp_group_mail': // group_tools/actions/mail.php
			...
			$subject = elgg_echo('cp_notify:subject:group_mail',array($params['cp_group_subject'],gc_explode_translation($params['cp_group']['name'],'en')),'en'). ' | ' . elgg_echo('cp_notify:subject:group_mail',array($params['cp_group_subject'],$params['cp_group']['name']),'fr');
