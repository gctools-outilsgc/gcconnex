...
<body style='font-family: sans-serif; color: #055959'>
	...
	<div width='100%' bgcolor='#fcfcfc'>
		...
		<p>
			<string><?php echo elgg_echo('cp_newsletter:greeting', array($to->name, date("Y/m/d")), $language_preference); ?>
			</strong>.
		</p>
		<br/>
		<br/>
		<div>
			<?php echo elgg_echo('cp_newsletter:body:nothing', array(), $language_preference); ?>
		</div>
		<br/>
		<br/>
		...
		<div width='100%' style='background-color:#f5f5f5; padding:5px 30px 5px 30px; font-family: sans-serif; font-size: 10px; color: #055959'>
			<center>
				<p>
					<?php echo elgg_echo('cp_notifications:contact_help_desk', array(), $language_preference); ?>
				</p>
				<p>
					<?php echo elgg_echo('cp_newsletter:footer:notification_settings', array($to->username), $language_preference); ?>
				</p>
			</center>
		</div>
	</div>
