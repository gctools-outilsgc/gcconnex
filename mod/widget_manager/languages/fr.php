<?php 
	...
	$french = array(
		...
		'widget_manager:widgets:image_slider:slider_type:random' => "Aléatoire",
		'widget_manager:widgets:image_slider:slider_type:random_heading' => "Points saillants de la communauté",
