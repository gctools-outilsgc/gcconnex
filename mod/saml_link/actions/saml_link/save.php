...
function db_match_success($user, $mail){
	...
	if ($blog_guid) {
      ...
      /////////////////////////////////////////////////////
      //hardcoded address
   		forward(elgg_get_plugin_setting('gcpedia_url','saml_link')."/simplesaml/module.php/core/as_login.php?AuthId=elgg-idp&ReturnTo=".elgg_get_plugin_setting('gcpedia_url','saml_link'));//$_SESSION["last_forward_from"]
	   //hardcoded
  } else {
   		//mysql_close($gcplink);
