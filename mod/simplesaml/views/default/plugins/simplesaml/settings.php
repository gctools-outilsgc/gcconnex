...
if (!empty($sources)) {
	...
	$content .= "<th class='center'>" . elgg_echo("simplesaml:settings:sources:remember_me") . "</th>";
	$content .= "</tr>";
	...
	foreach ($sources as $source) {
		...
		$content .= "<td class='center'>" . elgg_view("input/checkbox", array("name" => "params[" . $source_auth_id . "_remember_me]", "value" => "1") + $remember_me) . "</td>";
		$content .= "</tr>";
