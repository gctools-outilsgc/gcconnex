 ...
 * 3. Copy this file and modules/authelgg/www/resume.php to their corresponding
 *    location in the new module.
 * 4. Replace all occurrences of "authelgg" in this file and in resume.php with the name of your module.
 ...
 * @version $Id$
 */
class sspmod_authelgg_Auth_Source_External extends SimpleSAML_Auth_Source {
	...
	private function getUser() {
		...
		$attributes = simplesaml_get_user_attributes($this->getAuthId());
	...
	public function authenticate(&$state) {
		 ...
		 */
		$state['authelgg:AuthID'] = $this->authId;
		 ...
		 */
		$stateId = SimpleSAML_Auth_State::saveState($state, 'authelgg:External');
		 ...
		 */
		$returnTo = SimpleSAML_Module::getModuleURL('authelgg/resume.php', array(
			'State' => $stateId,
		));
		 ...
		 */
		$authPage = elgg_normalize_url("saml/idp_login");
	...
	public static function resume() {
		 ...
		 */
		$state = SimpleSAML_Auth_State::loadState($stateId, 'authelgg:External');

		/*
		 * Now we have the $state-array, and can use it to locate the authentication
		 * source.
		 */
		$source = SimpleSAML_Auth_Source::getById($state['authelgg:AuthID']);
		if ($source === NULL) {
			/*
