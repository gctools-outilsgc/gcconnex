...
'discussion:topic:notify:body' => '%s added a new discussion topic to the group %s: Title: %s %s View and reply to the discussion topic: %s ',	
'discussion:reply:notify:summary' => 'New reply in topic: %s',
'discussion:reply:notify:subject' => 'New reply in topic: %s',
'discussion:reply:notify:body' => '%s replied to the discussion topic %s in the group %s: %s View and reply to the discussion: %s ',	
'discussion:notification:topic:subject' => 'New discussion group',
'groups:notification' => '%s added a new group discussion in %s: %s %s Post and reply to discussion: %s',	
'discussion:notification:reply:body' => '%s replied to the a question %s in the group %s: %s Post and reply to discussion: %s ',
...
'groups:opengroup:membersonly:join' => 'To be a member, click the "Join group".',
...
'groups:invite:body' => "%s invited you to join the '%s' group. Click below to view your invitations: %s",
'groups:welcome:subject' => "Welcome to the %s group!",
'groups:welcome:body' => "You are now a member of the '%s' group! Click below to begin posting! %s",	
'groups:request:subject' => "%s has requested to join %s",
'groups:request:body' => "%s has requested to join the '%s' group. Click below to view their profile: %s or click below to view the group's join requests: %s",	
