...
foreach($fields as $field){
    ...
    $content = elgg_list_entities($options);
        ...
        if(elgg_get_page_owner_entity()->canEdit()){
            ...
            echo '<h3 class="wb-invisible" tabindex="-1">'.$title.'</h3>';
...
echo '<div role="tabpanel" tabindex="-1" class="tab-pane fade-in" id="events">';
    ...
    echo '<h3 class="wb-invisible" tabindex="-1">'.elgg_echo('event_calendar:listing_title:mine', array($user_display_name)).'</h3>';
