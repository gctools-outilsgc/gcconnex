...
// check if the user is deactivated before displaying interaction functionality
if (elgg_is_active_plugin('member_selfdelete') && (elgg_is_admin_logged_in() || $user->gcdeactivate == false)) {
...
} // end if condition, if user is deactivated
