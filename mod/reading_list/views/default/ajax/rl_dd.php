<?php
/*
This will populate a drop down that will show up when mousing over "reading list " in the user menu.
...
<div class="message-dd-holder">
  ...
  <?php
  echo '<div class="col-sm-12 mrgn-rght-sm mrgn-bttm-md brdr-bttm"><span class="message-dd-title">'.$title.'</span></div>';
  // echo elgg_view('page/elements/message_dd_list', array(
  //   'items'=>$latest_messages,
  //   'limit'=>6,
  //   'pagination'=>false,
  //   'no_results'=> elgg_echo ('no_results'),
  //   'dd_type'=>'rl_dd',
