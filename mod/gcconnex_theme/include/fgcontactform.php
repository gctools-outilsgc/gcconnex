...
class FGContactForm
{
	...
	public function EnableCaptcha($captcha_handler)
	{
	...
	public function SetConditionalField($field)
	{
		$this->conditional_field = $field;
	}
	public function AddConditionalReceipent($value, $email)
	{
		$this->arr_conditional_receipients[$value] =  $email;
	}

	public function AddFileUploadField($file_field_name, $accepted_types, $max_size)
	{
	...
	public function CollectConditionalReceipients()
	{
	...
	*/
	public function IsInternalVariable($varname)
	{
	...
	public function FormSubmissionToMail()
	{
		$ret_str='';
...
<div width="100%" bgcolor="#fcfcfc">
	...
	public function ExtraInfoToMail()
	{
		$ret_str='';
...
<head>
	...
	public function ComposeFormtoEmail()
	{
	...
	public function Validate()
	{
		...
		if (empty($_POST['email'])) {
			...
			$ret = false;
		} elseif (!$this->validate_email($_POST['email'])) {
			$numErr=$numErr+1;
			$this->add_error();
		...
		if (empty($_POST['depart'])) {
			...
			$ret = false;
		} elseif (strlen($_POST['depart'])>255) {
			$numErr=$numErr+1;
			$this->add_error();
	...
	public function ValidateFileType($field_name, $valid_filetypes)
	{
		$ret=true;
	...
	public function ValidateFileSize($field_name, $max_size)
	{
	...
	public function IsFileUploaded($field_name)
	{
