...
return array(
    ...
    'readonly:message' => 'GCConnex is in Read-Only Mode',
        'readonly:message:1' => 'You can no longer make new posts or create new content anywhere on GCConnex except for the <a href="https://gcconnex.gc.ca/missions/main" target="_blank">Career Marketplace</a>. You can export and save your existing content up until the <b>decommission later this fiscal year.</b>',
        ...
        "missions:placeholder_a" =>   "The Career Marketplace has moved to GCXchange! This page is read-only. 
Visit gcx
sove or export
<br>
<br>
