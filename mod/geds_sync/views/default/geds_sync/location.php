...
<script type="text/javascript">
	...
	function initMap() {
		...
		geocoder.geocode({
			'address': "<?php echo $loc->street.', '.$loc->city; ?>"
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo elgg_get_plugin_setting('map_key', 'geds_sync');;?>&signed_in=true&callback=initMap"></script>
		...
		<div class="panel panel-custom">
			<div class="panel-heading">
				...
				<div class="modal-title" id="title">
					<h2><?php echo elgg_echo('geds:map:title'); ?></h2>
				</div>
			</div>
