...
<div class="col-sm-12 clearfix mrgn-bttm-lg brdr-bttm">
    <div class="col-sm-4 clearfix" style="padding-top:75px" aria-label="GCconnex Decommission Image">
        <img class="mrgn-bttm-lg" src="<?php echo $site_url .'mod/gcconnex_read_only/graphics/GCconnex_Decom_Final_Banner.png'?>" style="width: 100%; height: auto; padding-right: 20px; margin-top: -25px;" alt="GCConnex Decommissioning Final Banner"/>
    </div>
