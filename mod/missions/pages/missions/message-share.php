...
switch ($switch_segment) {
	case 'wire':
		...
		} elseif ($entity->type == 'object' && get_subtype_from_id($entity->subtype) == 'mission') {
...
if ($entity_guid != 0) {
	elgg_push_breadcrumb(elgg_get_excerpt($entity->job_title,
		elgg_get_plugin_setting('mission_job_title_card_cutoff', 'missions')),
		$entity->getURL());
}
