...
<div class="row clearfix">
	<div class="col-sm-8 print-mission-more-holder">
		...
		<div class="mission-details mrgn-bttm-lg">
			<span name="mission-job-type">
				<?php
					echo elgg_echo($mission->job_type);
					if (!empty($mission->role_type)) {
						echo ' (' . strtolower(elgg_echo($mission->role_type)) . ')';
					}
				?>
			</span> <i class="fa fa-circle mrgn-lft-sm timeStamp mrgn-bttm-sm" aria-hidden="true" style="font-size:8px"></i>
