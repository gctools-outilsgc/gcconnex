...
<div class="clearfix panel panel-default" <?php echo $background_content; ?>>
	<div class="col-xs-12 user-info-content clearfix">
		...
		<div class="col-xs-12 mrgn-bttm-sm">
			...
			<div class="user-job-title" name="user-job-title">
				<?php echo $user->job; ?>
			</div>
			<div class="user-location timeStamp" name="user-location">
				<?php echo $user->location; ?>
			</div>
		</div>

		<div class="col-xs-12">
			<p class="mrgn-tp-0 mrgn-bttm-0 h4">
			...
			<div>
				...
				<?php
					if (count($user_skills) > 4) {
				?>
				<p>
					<span class="center-block"><a href="#mid-screen-<?php echo $user->guid; ?>" aria-controls="mid-screen-<?php echo $user->guid; ?>" class="overlay-lnk" role="button">View All Skills</a></span>
				</p>
