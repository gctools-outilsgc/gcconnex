...
return array(
    ...
    "mission:button:find" => '<span class="wb-inv"> canidates for the opportunity "%s"</span>',
        ...
        // labels
    "item:object:mission" =>     "Career Marketplace",
    //"missions:first_post:paragraph_one"
    "missions:zoomin" => "Zoom in",
    "missions:zoomout" => "Zoom out",
    "missions:zoomcenter" => "Reset",
    "missions:panleft" => "Pan-left",
    "missions:panright" => "Pan-right",
    ...
    "missions:parttime" => "Part time",
    "missions:filter:opportunity_role:label" => "Filter by role",
    "missions:filter:opportunity_role:title" => "Opportunity Role",
    "missions:filter:opportunity_role:offering" => "Offering",
    "missions:filter:opportunity_role:seeking" => "Seeking",
    "missions:filter:opportunity_type:label" => "Filter by type",
    ...
    "missions:error:opportunity_role_needs_input" => "Please enter a role for this opportunity.",
    ...
    "missions:error:security_needs_input" => "Please enter a security level for this opportunity",
    ...
    "missions:removed_from_mission_body" =>  "Thank you for your interest in this opportunity. Unfortunately, your application was not retained. Keep an eye out for another great opportunity!",
...
"missions:error:need_to_opt_in" =>  "You need to opt in to an opportunity type on your profile to access that page.",
    "missions:optin:continue"=>"Continue to Career Marketplace",
...
"missions:january_short" => "Jan",
"missions:february_short" => "Feb",
"missions_march_short" => "Mar",
"missions:april_short" => "Apr",
"missions:may_short" =>	" May",
"missions:june_short" => "Jun",
"missions:july_short" => "Jul",
"missions:august_short" => "Aug",
...
"missions:error:applicant_not_applied_to_mission" =>    "User %s has withdrawn this opportunity.",
...
"missions:admin_tool" =>"Career Marketplace Tool",
"missions:admin_tool_page" =>   "Career Marketplace administrator tool page",
...
"missions:placeholder_a" =>   "<b>The Career Marketplace is moving!</b> The Career Marketplace is moving to GCXchange, the new government-wide collaboration platform. 
The Career Marketplace will continue to be available on GCConnex until it launches on GCXchange by April 1, 2025. 
There will be no interruptions! You can continue to explore career development opportunities, connect with mentors, and browse postings from across the GC.
<br>
<br>
...
"missions:supervisor_notice_sentence" => "%s is notifying you they applied to the Micro-Mission '%s'.",
...
"missions:supervisor_notice_sentence" =>  "%s is notifying you they have applied to the opportunity: '%s'.",
"missions:application_notice_sentence_title" =>     "%s applied to your opportunity: '%s'",
...
"missions:time_in_hours" =>    "Time in hours",
    ...
    "missions:groupandlevel"=>"Group/level",
