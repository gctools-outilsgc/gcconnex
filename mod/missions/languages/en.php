...
"missions:splash:missions_right_now" => "If you require any help, <a href='http://www.gcpedia.gc.ca/wiki/GCconnex_User_Help/Jobs_Marketplace' target='_blank'>view our help page</a>.",
...
"missions:first_splash_paragraph" =>    "<a href='http://www.gcpedia.gc.ca/wiki/Jobs_Marketplace#Career_ConneXions_Opportunities_Platform target='_blank'>Learn more about micro-missions, mentoring, job shadowing, job swapping, etc. here!</a>",
"missions:second_splash_paragraph" =>   "To participate, check out some of our open opportunities below and click the opt in button at the bottom of the page. You will be redirected to your profile where you can edit the opt in feature and select the types of opportunities that interest you (as either a host or participant). Then, navigate back to the Opportunities Platform to get started!",
