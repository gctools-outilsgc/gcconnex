...
$security_string = ',' . 'missions:reliability' . ','
	. 'missions:enhanced_reliability' . ','
	. 'missions:secret' . ','
	. 'missions:top_secret';
...
$opportunity_type_string = 'missions:micro_mission' . ','
	. 'missions:mentoring' . ','
	. 'missions:job_swap' . ','
	. 'missions:job_shadowing' . ','
	. 'missions:assignment' . ','
	. 'missions:deployment' . ','
	. 'missions:job_rotation' . ','
	. 'missions:skill_share' . ','
	. 'missions:peer_coaching' . ','
	. 'missions:job_share';
...
$province_string = ',' . 'missions:alberta' . ','
	. 'missions:british_columbia' . ','
	. 'missions:manitoba' . ','
	. 'missions:new_brunswick' . ','
	. 'missions:newfoundland_and_labrador' . ','
	. 'missions:northwest_territories' . ','
	. 'missions:nova_scotia' . ','
	. 'missions:nunavut' . ','
	. 'missions:ontario' . ','
	. 'missions:prince_edward_island' . ','
	. 'missions:quebec' . ','
	. 'missions:saskatchewan' . ','
	. 'missions:yukon' . ','
	. 'missions:national_capital_region';
elgg_set_plugin_setting('province_string', $province_string, 'missions');

$program_area_string = ',' . 'missions:science' . ','
	. 'missions:information_technology' . ','
	. 'missions:administration' . ','
	. 'missions:human_resources' . ','
	. 'missions:finance' . ','
	. 'missions:legal_regulatory' . ','
	. 'missions:security_enforcement' . ','
	. 'missions:communications' . ','
	. 'missions:policy' . ','
	. 'missions:client_service';
elgg_set_plugin_setting('program_area_string', $program_area_string, 'missions');

$decline_reason_string = ',' . 'missions:decline:workload' . ','
	. 'missions:decline:interest' . ','
	. 'missions:decline:engagement'  . ','
	. 'missions:decline:approval'  . ','
	. 'missions:other';
