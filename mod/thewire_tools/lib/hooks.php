...
function thewire_tools_register_river_menu_items($hook_name, $entity_type, $return, $params) {
	...
	if (elgg_is_logged_in() && !empty($entity) && elgg_instanceof($entity, "object", "thewire")) {
		...
		$options = array(
			"name" => "reply",
			"text" => '<span class="fa fa-reply fa-lg icon-unsel"><span class="wb-inv">'.elgg_echo('reply').'</span></span>', //Nick P - I put this in here because it won't override in our theme. fight me
