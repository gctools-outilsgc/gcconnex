...
'gcx:messaging:login:list' => 'On Mayy 1, 2025, GCXchange will officially replace GCConnex as the Government of Canada’s new and improved collaboration space. With one simple sign on you can experience:',
...
'gcx:messaging:login:decom' => '<b> GCConnex will no longer be available after May 1, 2025, so please move your GCConnex content to a GCXchange community before that date. </b> Elevate your collaboration efforts—migrate to GCXchange today and be at the forefront of government innovation!',
