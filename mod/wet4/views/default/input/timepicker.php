...
echo elgg_view('input/dropdown', array('name' => $vars['name'].'_hour', 'value' => $hour, 'options_values' => $hours, 'style' => 'display:inline-block; width:auto;'));
echo " <b>:</b> ";
echo elgg_view('input/dropdown', array('name' => $vars['name'].'_minute', 'value' => $minute, 'options_values' => $minutes, 'style' => 'display:inline-block; width:auto;'));
if ($time_format == '12') {
