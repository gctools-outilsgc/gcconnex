...
<?php
	// displays the list of colleague circle(s) and radiobox for the circle option
	echo '</ul>';
	...
	foreach ($content as $key => $collection) {
		...
		// use the user's username not the name to allow sending to colleague circle
		foreach ($collections as $key => $value) {
			$name = get_user($value);
			$coll_members[] = $name->username;
		}
