...
if(isset(elgg_get_logged_in_user_entity()->department)){
  ...
  if(elgg_in_context('dept_activity')){
    echo '<ul class="nav nav-tabs"><li><a href="'.elgg_get_site_url().'newsfeed">'.elgg_echo('dept:activity:groupsandcolleagues').'</a></li><li class="elgg-state-selected active"><a href="'.elgg_get_site_url().'department">'.$dept[0].'</a></li></ul>';
  } else {
