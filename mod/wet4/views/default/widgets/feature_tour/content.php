...
//
$tour='<ol id="joyRideTipContent"><li data-id="activity" data-text="'.elgg_echo('gcTour:next').'"><h2>'.elgg_echo('gcTour:step1').'</h2><p>'.elgg_echo('gcTour:step1txt').'</p></li><li data-class="elgg-menu-item-groups" data-options="tipLocation:bottom" data-text="'.elgg_echo('gcTour:next').'"><h2>'.elgg_echo('gcTour:step4').'</h2><p>'.elgg_echo('gcTour:step4txt').'</p></li><li data-class="elgg-menu-item-thewire" data-options="tipLocation:bottom" data-text="'.elgg_echo('gcTour:next').'"><h2>'.elgg_echo('gcTour:step5').'</h2><p>'.elgg_echo('gcTour:step5txt').'</p></li><li data-id="tool-link" data-text="'.elgg_echo('gcTour:next').'"  data-options="tipLocation:bottom"><h2>'.elgg_echo('gcTour:step2').'</h2><p>'.elgg_echo('gcTour:step2txt').'</p></li><li data-class="elgg-menu-item-profile" data-text="'.elgg_echo('gcTour:next').'"  data-options="tipLocation:top"><h2>'.elgg_echo('gcTour:step3').'</h2><p>'.elgg_echo('gcTour:step3txt').'</p></li><li data-button="'.elgg_echo('gcTour:close').'"><h2>'.elgg_echo('gcTour:step6').'</h2><p>'.elgg_echo('gcTour:step6txt').'</p></li></ol>';
