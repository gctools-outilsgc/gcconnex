...
elgg_register_menu_item('user_menu', array(
    'name' => 'messages',
    'text' => /*'<a href="'.elgg_get_site_url().'messages/inbox/' . $user.'">*/'<i class="fa fa-envelope mrgn-rght-sm mrgn-tp-sm fa-lg"></i><span class="hidden-xs" aria-hidden="true">' . elgg_echo('messages') . '</span>' . $msgbadge .'<span class="wb-inv">'.elgg_echo('userMenu:messages') . $title.' </span></a>'.$focus_dd .$ajax_dd_messages,
...
elgg_register_menu_item('user_menu', array(
    'name' => 'notifications',
    'text' => /*'<a href="'.elgg_get_site_url().'messages/notifications/' . $user.'">*/'<i class="fa fa-bell mrgn-rght-sm mrgn-tp-sm fa-lg"></i><span class="hidden-xs">' . elgg_echo('notifications:subscriptions:changesettings') . '</span>' . $msgbadge .'<span class="wb-inv">'.elgg_echo('userMenu:notifications') . $title.' </span></a>'.$focus_dd.'<div>'.$ajax_dd_notification.'</div>',
