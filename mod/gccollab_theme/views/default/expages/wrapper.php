...
var en_list = ["terms","faq","participating_organizations","privacy","about"];
var fr_list = ["termes","qfp","organismes_participants","confidentialite","a_propos"];
