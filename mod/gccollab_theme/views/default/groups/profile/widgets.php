...
if($object->title){
		...
		$groupName = gc_explode_translation($object->name, $lang);
}
...
<div id="groups-tools" class="tab-content clearfix">
    ...
    <div id="etherpad" class="tab-pane fade-in ">
        <h2 class="wb-inv"><?php echo  elgg_echo('etherpad:owner', array($groupName));?></h2>
        <div class="wet-ajax-loader" aria-hidden="true">
            <img src="<?php echo $site_url.'mod/wet4/graphics/loading.gif';?>" alt="loading content" />
        </div>
    </div>
