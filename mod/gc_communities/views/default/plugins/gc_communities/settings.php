	...
	$(function() {
		...
		$("a.add-community").click(function(e){
		    ...
		    if(community_en !== "" && community_fr !== "" && community_url !== "" && community_tags !== ""){
		    	...
		    	var community = { 'community_en': community_en, 'community_fr': community_fr, 'community_url': community_url, 'community_tags': community_tags, 'community_animator': community_animator };
...
if (count($communities) > 0) {
	...
	echo '<thead><tr> <th></th> <th>'.elgg_echo('gc_communities:title').' (EN)</th> <th>'.elgg_echo('gc_communities:title').' (FR)</th> <th>'.elgg_echo('gc_communities:url').'</th> <th>'.elgg_echo('gc_communities:tags').'</th> <th>'.elgg_echo('gc_communities:animator').'</th> <th></th> <th></th> </tr></thead>';
