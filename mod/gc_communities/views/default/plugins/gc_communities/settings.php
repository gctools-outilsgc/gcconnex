...
<script type="text/javascript">
	$(function() {
		function toggleButtons(key){
            ...
            $('select[data-url=' + key + ']').prop("disabled", function(i, v){ return !v; });
		...
		$("a.add-community").click(function(e){
		    ...
		    if(community_en !== "" && community_fr !== "" && community_url !== "" && community_tags !== ""){
		    	...
		    	var community = { 'community_en': community_en, 'community_fr': community_fr, 'community_url': community_url, 'community_tags': community_tags, 'community_animator': community_animator, 'community_audience': community_audience };
