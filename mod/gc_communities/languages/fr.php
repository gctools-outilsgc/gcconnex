...
$french = array(
	...
	'gc_communities:showing_content' => 'Ce fil de nouvelle montre le contenu avec les mots clés: %s et qui a été identifié comme étant utile pour les communautés suivantes: %s',
);
