...
return array(
	...
	*/
		...
		'thewire:friends' => "Messages de mes contacts sur le fil",
		'thewire:read' => "Messages sur le fil",
		'thewire:strapline' => "%s",
		...
		'thewire:doing' => "Vous travaillez sur quelque chose d'intéressant? Informez-en tout le monde sur le fil :",
