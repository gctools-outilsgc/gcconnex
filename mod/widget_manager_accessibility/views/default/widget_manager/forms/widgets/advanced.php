...
//modified by Nick P to add labels to widget setting inputs
$noyes_options = array_reverse($yesno_options, true);

$advanced = "<div class='always-seen-bb' id='widget-manager-widget-edit-advanced-" . $widget->getGUID() . "'>";
$labelId = 'title-label-'.$widget->getGUID();
$labelIdUrl = 'url-label-'.$widget->getGUID();
