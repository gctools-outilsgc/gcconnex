...
return array(
  ...
  'freshdesk:page:title' => "Aide / Contactez-nous",

  //search knowledge base
  'freshdesk:knowledge:title' => "Contenu d’aide",
  'freshdesk:knowledge:search:title' => "Comment pouvons-nous vous aider aujourd’hui?",
  'freshdesk:knowledge:search:info' =>  "Besoin d'aide? Faites une recherche dans notre contenu d'aide pour trouver des informations et des tutoriels qui vous guideront! <br> <b>Remarque:</b> Le contenu d'aide est hébergé sur FreshDesk, un outil tiers qui vous permet de rechercher facilement des articles de contenu d'aide, ainsi que de soumettre et de suivre les billets du bureau d’aide. Lorsque vous naviguez dans le contenu d'aide ci-dessous, vous serez peut-être redirigé vers le site Web de FreshDesk. ",

  'freshdesk:knowledge:explore:title' => "Explorer le contenu d’aide",

  'freshdesk:knowledge:explore:return' => 'Retour aux catégories de la base de connaissances',

  //submit ticket form
  'freshdesk:ticket:title' => "Soumettre un ticket",
  ...
  'freshdesk:ticket:submit:confirmed' => "Votre ticket a été soumis.",
