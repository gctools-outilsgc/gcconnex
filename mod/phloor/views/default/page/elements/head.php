...
$hide_elgg_metadata = elgg_get_plugin_setting('hide_elgg_metadata', 'phloor');
if(strcmp('true', $hide_elgg_metadata) != 0) {	
	$phloor_version = phloor_get_version();
	$phloor_release = phloor_get_version(true);
	
	echo "<meta name=\"ElggRelease\" content=\"{$release}\" />";
	echo "<meta name=\"ElggVersion\" content=\"{$version}\" />";
}
?>
