...
$delete_content = elgg_echo('gcforums:delete:body', array(elgg_echo("gcforums:delete:{$entity->getSubtype()}")));
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-danger <?php echo $button_size; ?>" data-toggle="modal" data-target="#myModal"><?php echo $delete; ?></button>
