...
'file:list' => "Affichage de la liste",
'file:group' => "Fichiers de groupes",
'file:gallery' => "Affichage de la galerie",
'file:gallery_list' => "Affichage de la galerie ou de la liste",
'file:num_files' => "Nombre de fichiers à afficher",
'file:user:gallery'	=> 'Afficher la galerie de %s',
'file:upload' => "Téléverser un fichier",
		
'file:add' => 'Téléverser un fichier',
'file:list:list' => 'Passer à l\'affichage de la liste ',
...
'file:replace' => 'Remplacer le contenu du fichier (laisser en blanc pour ne pas modifier le fichier)',
'file:title:friends' => "Collègues",
'file:file' => "Fichier",
'file:title' => "Titre",
'file:type:' => "Fichiers",
...
'file:type:general' => "Fichiers généraux",
...
'file:widget:description' => "Mettre en évidence vos derniers fichiers",
...
'file:saved' =>	"Enregistrement du fichier réussi.",
'file:deleted' => "Suppression du fichier réussie.",
...
'file:noaccess' => "Vous n'avez pas les permissions requises pour modifier ce fichier.",
