...
'file:type:audio' => "Audio files",
'file:type:image' => "Pictures",
'file:type:general' => "General files",
	
'file:user:type:video' => "%s's videos",
'file:user:type:document' => "%s's documents",
'file:user:type:audio' => "%s's audio files",
