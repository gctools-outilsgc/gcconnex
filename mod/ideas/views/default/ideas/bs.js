 ...
 */
    var getRateButtons = function(vote,elem) {
        ...
        if(vote == 1) {
            ...
            elem.find("span").removeClass().addClass("elgg-icon elgg-icon-thumbs-down-alt");
    ...
    $('.idea-vote-container a').live('click', function(e) {
        ...
        if ($.data(this, 'clicked') || $(this).hasClass('checked')) // Prevent double-click
            ...
            var old_points = $('#elgg-object-' + idea + ' .idea-points').html();
            ...
            elgg.action(rateurl, {
                ...
                success: function(json) {
                    ...
                    if ( !json.output.errorRate ) {
                        ...
                        $('#elgg-object-' + idea + ' .idea-points').html(json.output.sum + "<span>" + ((json.output.sum == 1 || json.output.sum == -1) ? "point" : "points") + "</span>");
