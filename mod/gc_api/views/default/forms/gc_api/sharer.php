...
<div>
    <?php
		...
		//Hidden input to pass the link address to the action
	?>
    ...
    <div>
        <?php
			echo elgg_view('input/checkbox',
				array('name'=>'share_on_wire',
				'label'=>elgg_echo('gcconnexshare:share_on_wire'),
				'value'=>'share_on_wire',
			));
			//Share checkbox
		?>
...
<div>
    <?php
		echo elgg_view('input/submit',
			array('value' => elgg_echo('bookmarks:add'),
