...
function main() { 
    jQuery(document).ready(function($) { 
        ...
        var css_link = $("<link>", { 
            rel: "stylesheet", 
            type: "text/css", 
            href: site+"mod/gc_api/widget/en/widget.css" 
        });
        ...
        if (originalQ != ''){
            //$( "#container" ).append("<div class='wire-widget-header' id='widget-head'><h3>The GCconnex Wire</h3>search for "+originalQ+"</div>");
            $( "#container" ).append("<div class='wire-widget-header' id='widget-head'><h3>The GCconnex Wire</h3></div>");
            $( "#widget-head" ).append('<div class="wire-widget-filter-text">Showing posts with:</div>');
            if (!nameq){
            ...
            $( "#container" ).append("<div class='wire-widget-header' id='widget-head'><h3>The Wire</h3></div>");
        }
        $( "#container" ).append("<div class='wire-widget-body' id='widget-body'><ul class='wire-widget-list'></ul></div>");
        $( "#container" ).append("<div class='wire-widget-footer' id='widget-footer'><div class='gcconnex-link'><a href='"+site+"'>Visit GCconnex</a></div></div>");
        doAjax();
            ...
            $.ajax({
                ...
                success: function(feed){
                   ...
                   if (typeof postArray === "undefined"){
                        ...
                        moreButton.innerHTML = "No Posts to Show";
                    	...
                    	if ($( "#widget-body ul li" ).length==limit){
                    	    ...
                    	    var moreButton = document.createElement("BUTTON");
                    	    moreButton.className = "wire-widget-load-more";
                    	    moreButton.innerHTML = "Load more Posts";
